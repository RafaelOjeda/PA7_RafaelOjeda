...
public class Maze {
    class Cell { // Inner class used to construct the maze
		// Every individual cell has an option the following booleans are the options for each cell.
		public boolean deadEnd = false, noRight = false, noLeft = false, noDown = false, noUp = false, start = false, target = false;
